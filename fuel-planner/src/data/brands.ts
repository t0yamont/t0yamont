...
// mixedCarb: true = glucose:fructose or maltodextrin:fructose blend (oxidises above ~60 g/h)
// caffeineMg: actual caffeine content in mg per serving
export const PRODUCTS: Record<FuelBrand, Product[]> = {
  ...
  high5: [
    ...
    // High5 Energy Drink uses maltodextrin + fructose blend
  ...
  tailwind: [
    // Tailwind uses sucrose (breaks into glucose + fructose) — mixed-carb
  ...
  veloforte: [
    // Veloforte uses fruit-based carbs; single-source classification (VERIFY with label)
  ...
  generic: [
    ...
    { id: 'generic_bar',         name: 'Energy Bar (≈40g carb)',       carbsG: 40, sodiumMg: 50,  fluidMl: 0,   caffeineMg: 0,  mixedCarb: false, type: 'bar',   canUseOnSwim: false, canUseOnRun: false, caffeinated: false },
    { id: 'generic_drink',       name: 'Sports Drink (500ml bottle)',  carbsG: 30, sodiumMg: 200, fluidMl: 500, caffeineMg: 0,  mixedCarb: false, type: 'drink', canUseOnSwim: false, canUseOnRun: false, caffeinated: false },
